...
stdenv.mkDerivation rec {
  pname = "vesktop";
  version = "0.3.3+baaecab";

  src = fetchFromGitHub {
    owner = "Vencord";
    repo = "Vesktop";
    rev = "baaecab523486e9556804cc43aa06b4a56e2974c";
    sha256 = "sha256-zbbQRa7JdTx2Be2ECnhUX+1iE7bfoD+h3y2N/qrJkaA=";
  };
  ...
  pnpm-deps = stdenvNoCC.mkDerivation {
    ...
    outputHash = "sha256-6kVaApe2gP8NeJQXZJZrJTY74ZI/ww01Q3Dn/5GnQDY=";
  };
  ...
  desktopItems = [
    (makeDesktopItem {
      name = "vencorddesktop";
      desktopName = "Vesktop";
      exec = "vencorddesktop --ozone-platform-hint=auto --enable-webrtc-pipewire-capturer %U";
      icon = "vencorddesktop";
